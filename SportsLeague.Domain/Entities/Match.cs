...
namespace SportsLeague.Domain.Entities
{
    public class Match : AuditBase
    {
        ...
        public MatchResult? MatchResult { get; set; } // Relación 1:1 con resultado
        public ICollection<Goal> Goals { get; set; } = new List<Goal>(); // Relación 1:N con gol
        public ICollection<Card> Cards { get; set; } = new List<Card>(); // Relación 1:N con tarjeta
